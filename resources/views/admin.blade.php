        ...
        <div class="container-xl">
            <div class="row mt-3">
                <div class="col-sm-12 text-center">
                    ...
                    <a href="#SetMarkModal" class="btn btn-success" data-toggle="modal"><i
                            class="material-icons">&#xE147;</i> <span>Set Mark</span></a>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->status }}</td>
                                    <td>
                                        <a href="#editUserModal" class="edit edit-icon" data-toggle="modal"
